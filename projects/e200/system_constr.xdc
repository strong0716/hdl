...
set_property -dict {PACKAGE_PIN Y9 IOSTANDARD LVCMOS33} [get_ports emio_uart1_txd];
set_property -dict {PACKAGE_PIN Y6 IOSTANDARD LVCMOS33} [get_ports emio_uart1_rxd];
